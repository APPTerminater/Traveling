...
public class UserInfoDao {
    ...
    // 增加的方法，返回的的是一个long值
    public long addData(String nickname,String birthday,String password,String walkDaliy) {
        ...
        contentValues.put(UserInfo.KEY_walk,Integer.valueOf(walkDaliy));
    ...
    public String alterMode(String nickname) {
        ...
        Cursor cursor = readableDatabase.query(UserInfo.TABLE,
                new String[]{"prefer_mode"}, "nickname=?",
    ...
    public String alterPassword(String nickname) {
        ...
        Cursor cursor = readableDatabase.query(UserInfo.TABLE, new String[]{"password"},
    ...
    public String alterBirthday(String nickname) {
        ...
        Cursor cursor = readableDatabase.query(UserInfo.TABLE, new String[]{"birthday"},
                "nickname=?", new String[]{nickname}, null, null, null);
        if (cursor.moveToNext()) {
    ...
    public int alterWalk(String nickname) {
        ...
        Cursor cursor = readableDatabase.query(UserInfo.TABLE, new String[]{"walk_daliy"},
                "nickname=?", new String[]{nickname}, null, null, null);
        if (cursor.moveToNext()) {
            walkDaliy = cursor.getInt(0);
        }
        cursor.close(); // 记得关闭 cursor
        readableDatabase.close(); // 关闭数据库
        return walkDaliy;
