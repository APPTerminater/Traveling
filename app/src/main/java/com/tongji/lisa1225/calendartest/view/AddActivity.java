...
public class AddActivity extends AppCompatActivity implements View.OnClickListener, OnDateSetListener {
    ...
    private CheckBox isremind2;
    private RelativeLayout addTripLayout;
    ...
    private TimePickerDialog dialogAll2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化
        tripDao = new TripInfoDao(AddActivity.this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.goTime:
                ...
                dialogAll.show(getSupportFragmentManager(), "time");
                break;

            case R.id.backTime:
                dialogAll2 = new TimePickerDialog.Builder()
                ...
                dialogAll2.show(getSupportFragmentManager(), "time");
                break;
            default:
                break;
        }
    ...
    //判断出发时间是否晚于回程时间
    private boolean dateWarning(int num) {
    ...
    public void submit(View view) {
        ...
        if (TextUtils.isEmpty(tripInfo.destination) || TextUtils.isEmpty(money.getText().toString().trim())
            ...
            long addLong = tripDao.addData(tripInfo);
            if (addLong == -1) {
